...
const categories = [
  { separator: "platforms" },
  { id: "bolt", platform: true, label: { ro: "Bolt Food", en: "Bolt Food" }, desc: { ro: "Modificare date (IBAN, nr. tel., vehicul etc.), deblocare cont etc.", en: "Update details (IBAN, phone, vehicle etc.), unblock account and more." }, icon: "B", logo: "../assets/ticket-bolt-round.png", logoScale: "1.21", accent: "#35d187" },
  { id: "glovo", platform: true, label: { ro: "Glovo", en: "Glovo" }, desc: { ro: "Modificare date (IBAN, nr. tel., vehicul etc.), comenzi, deblocare cont etc.", en: "Update details (IBAN, phone, vehicle etc.), orders, unblock account and more." }, icon: "G", logo: "../assets/ticket-glovo-round.png", logoScale: "1.14", accent: "#ffbf05" },
  { id: "wolt", platform: true, label: { ro: "Wolt", en: "Wolt" }, desc: { ro: "Modificare date (IBAN, nr. tel., vehicul etc.), deblocare cont etc.", en: "Update details (IBAN, phone, vehicle etc.), unblock account and more." }, icon: "W", logo: "../assets/ticket-wolt-round.png", logoScale: "1.24", accent: "#00c2e8" },
  { separator: "admin" },
