...
const categories = [
  { separator: "platforms" },
  { id: "bolt", platform: true, label: { ro: "Bolt Food", en: "Bolt Food" }, desc: { ro: "Modificare date (IBAN, nr. tel., vehicul etc.), deblocare cont etc.", en: "Update details (IBAN, phone, vehicle etc.), unblock account and more." }, icon: "B", logo: "../assets/ticket-bolt-round.png", logoScale: "1.06", accent: "#35d187" },
  ...
  { id: "wolt", platform: true, label: { ro: "Wolt", en: "Wolt" }, desc: { ro: "Modificare date (IBAN, nr. tel., vehicul etc.), deblocare cont etc.", en: "Update details (IBAN, phone, vehicle etc.), unblock account and more." }, icon: "W", logo: "../assets/ticket-wolt-round.png", logoScale: "1.07", accent: "#00c2e8" },
  { separator: "admin" },
