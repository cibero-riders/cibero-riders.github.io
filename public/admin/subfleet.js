...
const ticketDisplayModeSwitch = document.querySelector("#subfleet-ticket-display-switch");
...
function renderTicketNavigation() {
  ...
  ticketDisplayModeSwitch.setAttribute("aria-checked", String(activeTicketDisplayMode === "all"));
